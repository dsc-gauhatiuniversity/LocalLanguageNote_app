...
import com.djd.youniversityNotebook.util.NoteBottomSheetFragment
...
class CreateNoteFragment : BaseFragment(), EasyPermissions.PermissionCallbacks,
        ...
        if (noteId != -1) {
            ...
            launch {
                context?.let {
                    ...
                    noticetitle.setText(notes.title)
                    noticesubtitle.setText(notes.subTitle)
                    noticedescription.setText(notes.noteText)
                    if (notes.imgPath != "") {
    ...
    private fun updateNote() {
        launch {
            ...
            context?.let {
                ...
                notes.title = noticetitle.text.toString()
                notes.subTitle = noticesubtitle.text.toString()
                notes.noteText = noticedescription.text.toString()
    ...
    private fun saveNote() {
        ...
        if (noticetitle.text.isNullOrEmpty()) {
            Toast.makeText(context, "Note Title is Required", Toast.LENGTH_SHORT).show()
        } else if (noticesubtitle.text.isNullOrEmpty()) {

            Toast.makeText(context, "Note Sub Title is Required", Toast.LENGTH_SHORT).show()
        } else if (noticedescription.text.isNullOrEmpty()) {
